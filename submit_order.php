...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $insert_query = "INSERT INTO royale_product_order_tbl 
        (user_id, order_type, order_variation, order_status, user_name, user_contact_number, user_gender, user_email, user_address, pickup_date, pickup_time, product_id, product_name, product_type, product_gender, product_color, product_size, product_quantity, product_price, product_photo, datetime_order) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
