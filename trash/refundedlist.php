...
$manage_data = ['order_id' => '', 'req_fname' => '', 'req_mname'=>'', 'req_lname'=>'', 'req_contact'=>'', 'req_address'=>'', 'req_gender'=>'', 'req_type'=>'','req_date'=>'' ,'deadline'=>'', 'comment'=>'', 'req_image'=> '','assigned_emp'=> '','price'=> '', 'Measurements' =>'', 'refund'=>''];   
...
<head>
    ...
    <link rel="stylesheet" href="refundedlist.css?v=<?php echo time(); ?>">
    <link rel="shortcut icon" href="../img/Logo.png" type="image/png">
    <title>Refundedlist</title>
...
<div class="navbar"> 
    ...
    <div class="container">
        <div class="for-label">
            <label class="for-label-text">REFUNDED LISTS</label>
        </div>
        ...
        <form class="for-table" >
            ...
            <tr>
                ...
                <td td class="td2">
                     <button class="manage-btn" type="submit" name="manage"><a href="refundedlist.php?manage_id=<?php echo $id; ?>">Check</a></button>
                </td>
            </tr>
        ...
        <div class="for-return">
            <button class="return-btn" ><a href="../admin/returnedlist.php">Return</a></button>
                    </div>
        ...
        <label for="req-date" class="label1">Assigned Employee:</label><br>
            ...
            <input type="number" name="refund" class="req-input"  required value="<?php echo $manage_data['refund']; ?>"><br><br>
