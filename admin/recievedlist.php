...
<head>
    ...
    <link rel="stylesheet" href="recievedlist.css?v=<?php echo time(); ?>">
    <link rel="shortcut icon" href="../img/Logo.png" type="image/png">
    <title>Recievedlist</title>
...
<div class="navbar"> 
    ...
    <div class="container">
        <div class="for-label">
            <label class="for-label-text">RECIEVED LISTS</label>
        </div>
        ...
        <form class="for-table" >
            ...
            <tr>
                ...
                <td td class="td2">
                     <button class="manage-btn" type="submit" name="manage"><a href="recievedlist.php?manage_id=<?php echo $id; ?>">Check</a></button>
                </td>
            </tr>
        ...
        <div class="for-return">
            <button class="return-btn" ><a href="../admin/finishedlist.php">Return</a></button>
                    </div>
        ...
        <button type="submit" name="returned" class="mrk-returned-btn">Mark as Returned</button> 
        </div><br><br>
        </form>
        </div>  
    </div>
