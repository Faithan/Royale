        ...
        <main>
            <div class="header-container">
                ...
                <div class="header-label-container">
                    ...
                    <label for="">Walkin Request</label>
                </div>
            ...
            <div class="content-container">
                ...
                <div class="content" data-status="<?php echo ucfirst($row['request_status']); ?>">
                                    ...
                                    function cancelRequest() {
                                        Swal.fire({
                                            ...
                                            if (result.isConfirmed) {
                                                ...
                                                form.method = 'POST';
                                                form.action = 'walkin_request_action.php';
                    ...
                    <!-- update and ongoing  -->
                    <form action="walkin_request_action.php" method="POST" class="additional-info-container" style="display: <?php echo ($row['request_status'] === 'pending' || $row['request_status'] === 'cancelled') ? 'none' : ''; ?>">
