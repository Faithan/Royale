    ...
    <div class="container">
        ...
        <form class="for-table" >
            ...
            <tr>
                ...
                <td td class="td2">
                     <button class="manage-btn" type="submit" name="manage"><a href="requestlist.php?manage_id=<?php echo $id; ?>">Check</a></button>
                </td>
            </tr>
        ...
        <div class="request-form-label">    
            ...
            <input type="text" name="order_id" class="req-input" required value="<?php echo $manage_data['order_id']; ?>" readonly><br>
