...
<head>
    ...
    <link rel="stylesheet" href="dashboard-transaction.css?v=<?php echo time(); ?>">
    ...
    <body>
        ...
        <div class="container"> 
            ...
            <div class="side-container">
                ...
                <li><a href="../user/dashboard-transaction.php" class="underline">Transaction History</a></li><hr>
            ...
            <div class="center-dashboard">
                <div class="up-dashboard-title"> 
                     <label class="up-dashboard-label">Transaction History</label>
                </div>
                ...
                <div class="side-nav-dashboard">
                     <div class="side-nav-dashboard-list">
                        <ul>
                            <li><a href="#" class="underline">Order History</a></li><hr>
