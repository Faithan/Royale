    ...
    <body>
        ...
        <div class="container"> 
            ...
            <div class="side-container">
                ...
                <li><a href="../user/dashboard-request.php" class="underline">Request</a></li><hr>
            ...
            <div class="center-dashboard">
                <div class="up-dashboard-title"> 
                     <label class="up-dashboard-label">Request</label>
                </div>
                ...
                <div class="side-nav-dashboard">
                     <div class="side-nav-dashboard-list">
                        <ul>
                            <li><a href="#" class="underline">Unreplied</a></li><hr>
                            <li><a href="#">Accepted</a></li><hr>
                            <li><a href="#">Ongoing</a></li><hr>
                            <li><a href="#">Done/Recieved</a></li><hr>
                            <li><a href="#">Refunded/Returned</a></li><hr>
                            <li><a href="#">Cancelled/Rejected</a></li><hr>
                        </ul>
                        </div>
                </div>
